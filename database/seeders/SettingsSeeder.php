...
class SettingsSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            [
                'key' => 'recording_lookup_window_days',
                'value' => '14',
                'type' => 'integer',
                'group' => 'attendance',
                'label_ar' => 'مدة البحث عن رابط تسجيل الجلسة بعد انتهائها (يوم)',
                'description' => 'الفحص الدوري يتوقف عن محاولة جلسة تجاوز عمرها هذه المدة دون رابط تسجيل',
            ],
